...
#     It relies on your models (e.g., File, Tag) being imported elsewhere in your app
...
#         # OperationalError is already handled by get_engine() during initial connection test.
#         # This catch is for errors during create_all itself, less common.
#         print("Failed to create tables. Check database permissions or schema definitions.")
#         raise
#     except Exception as e:
